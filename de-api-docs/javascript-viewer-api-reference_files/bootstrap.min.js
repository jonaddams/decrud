...
/*!
 * Generated using the Bootstrap Customizer (https://getbootstrap.com/docs/3.3/customize/?id=e3e35d463c04c87ff977abe209977c2d)
 * Config saved to config.json and https://gist.github.com/e3e35d463c04c87ff977abe209977c2d
 */
...
+((t) => {
  ...
  +((t) => {
    ...
    (i.VERSION = '3.3.7'),
      ...
      (i.prototype.getDefaults = () => i.DEFAULTS),
      ...
      (i.prototype.getCalculatedOffset = (t, e, i, o) =>
        'bottom' == t
  ...
  +((t) => {
    ...
    (o.VERSION = '3.3.7'),
      ...
      (o.prototype.addAriaAndCollapsedClass = (t, e) => {
        var i = t.hasClass('in');
